input_string = """13-16 k: kkkkkgmkbvkkrskhd
5-6 p: qpppvzp
3-4 p: psppxhlfpvkh
...
for i in x:
    ...
    split_input = [j for j in i.split()]
    allowed_position = [int(k) for k in split_input[0].split('-') if k.isdigit()]
    alphabet = split_input[1].rstrip(':')
     
    if alphabet == split_input[2][allowed_position[0] - 1] or alphabet == split_input[2][allowed_position[1] - 1]:
        passwords_valid.append(i)

    if alphabet == split_input[2][allowed_position[0] - 1] and alphabet == split_input[2][allowed_position[1] - 1]:
        passwords_valid.remove(i)
print(len(passwords_valid))
